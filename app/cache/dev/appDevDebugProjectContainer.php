...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tunisiea', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\src\\Tunisie\\FeedsBundle\\Entity')), 'Tunisie\\FeedsBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TunisieFeedsBundle' => 'Tunisie\\FeedsBundle\\Entity'));
        ...
        $b->setProxyDir('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_59f1fd89e31ce4244c2ccbe718f934529d2e512b0d72b4ec0ac25de2de40e88e');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/Resources');
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'TunisieFeedsBundle:Default:twitter_bootstrap_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 10));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/logs/dev.log', 100, true, NULL);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['sonata.seo.event.breadcrumb'] = new \Sonata\SeoBundle\Event\BreadcrumbListener();
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/twig', 'charset' => 'UTF-8', 'debug' => true, 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\src\\Tunisie\\FeedsBundle/Resources/views', 'TunisieFeeds');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\knplabs\\knp-paginator-bundle\\Knp\\Bundle\\PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\sonata-project\\seo-bundle\\Sonata\\SeoBundle/Resources/views', 'SonataSeo');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/Resources/views');
        $instance->addPath('C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('89cce131e6bcd1a224a24785a46d7e0a8ddc37d0');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev',
            'kernel.logs_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/logs',
            'kernel.bundles' => array(
                ...
                'TunisieFeedsBundle' => 'Tunisie\\FeedsBundle\\TunisieFeedsBundle',
            ...
            'locale' => 'en',
            'secret' => '89cce131e6bcd1a224a24785a46d7e0a8ddc37d0',
            ...
            'debug.container.dump' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '89cce131e6bcd1a224a24785a46d7e0a8ddc37d0',
            ...
            'session.save_path' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\home\\UwAmp_3.0.1\\UwAmp\\www\\feed\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'debug' => true,
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/../web',
            'assetic.write_to' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/home/UwAmp_3.0.1/UwAmp/www/feed/app/cache/dev/doctrine/orm/Proxies',
            ...
            'knp_paginator.template.pagination' => 'TunisieFeedsBundle:Default:twitter_bootstrap_pagination.html.twig',
