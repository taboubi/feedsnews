...
class appDevProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/app/apache2/htdocs/issam/app/cache/dev/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/app/apache2/htdocs/issam/app/cache/dev/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/app/apache2/htdocs/issam/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/app/apache2/htdocs/issam/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'feeds', 'user' => 'issam', 'password' => 'Ta529621', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/app/apache2/htdocs/issam/src/Tunisie/FeedsBundle/Entity')), 'Tunisie\\FeedsBundle\\Entity');
        ...
        $b->setProxyDir('/app/apache2/htdocs/issam/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ad5efc12c763d261c3147a285ea42bc2f1d9799697264754cd908a21a0310dfe');
        return $instance;
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/app/apache2/htdocs/issam/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/app/apache2/htdocs/issam/app/logs/dev.log', 100, true, NULL);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/app/apache2/htdocs/issam/app/cache/dev/profiler', '', '', 86400), $a);
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/app/apache2/htdocs/issam/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/app/apache2/htdocs/issam/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/app/apache2/htdocs/issam/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/app/apache2/htdocs/issam/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/app/apache2/htdocs/issam/app/cache/dev/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/app/apache2/htdocs/issam/app/cache/dev/twig', 'charset' => 'UTF-8', 'debug' => false, 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/app/apache2/htdocs/issam/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/symfony/swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/app/apache2/htdocs/issam/src/Tunisie/FeedsBundle/Resources/views', 'TunisieFeeds');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/sonata-project/seo-bundle/Sonata/SeoBundle/Resources/views', 'SonataSeo');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/app/apache2/htdocs/issam/app/Resources/views');
        $instance->addPath('/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/app/apache2/htdocs/issam/app/../web', false);
        $instance->addWorker(new \Symfony\Bundle\AsseticBundle\Factory\Worker\UseControllerWorker());
        return $instance;
    }
    protected function getAssetic_CacheService()
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/app/apache2/htdocs/issam/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/app/apache2/htdocs/issam/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/app/apache2/htdocs/issam/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/app/apache2/htdocs/issam/app/cache/dev',
            'kernel.logs_dir' => '/app/apache2/htdocs/issam/app/logs',
            ...
            'session.save_path' => '/app/apache2/htdocs/issam/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/app/apache2/htdocs/issam/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/app/apache2/htdocs/issam/app/cache/dev/profiler',
            ...
            'router.resource' => '/app/apache2/htdocs/issam/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/app/apache2/htdocs/issam/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'debug' => false,
                'paths' => array(
                ),
            ...
            'swiftmailer.spool.default.memory.path' => '/app/apache2/htdocs/issam/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/app/apache2/htdocs/issam/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/app/apache2/htdocs/issam/app/../web',
            'assetic.write_to' => '/app/apache2/htdocs/issam/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/app/apache2/htdocs/issam/app/cache/dev/doctrine/orm/Proxies',
