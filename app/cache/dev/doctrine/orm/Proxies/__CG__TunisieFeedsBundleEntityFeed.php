 ...
 */
class Feed extends \Tunisie\FeedsBundle\Entity\Feed implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'url', 'source', 'language', 'favicon', 'lastUpdate', 'isActive', 'factory', 'articles', 'categorie');
        }
