 ...
 */
class Jarida extends \Tunisie\FeedsBundle\Entity\Jarida implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'source', 'language', 'favicon', 'lastUpdate', 'isActive', 'factory', 'articles', 'categorie');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Jarida $proxy) {
    ...
    public function setFactory($factory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFactory', array($factory));
    ...
    public function getFactory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFactory', array());
